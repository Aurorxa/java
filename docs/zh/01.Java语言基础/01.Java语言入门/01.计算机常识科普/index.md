...
* 底层应用/系统开发指的是进行一些系统层面，接近硬件层面的应用开发，如：数据库、操作系统、浏览器、游戏引擎、编译器、硬件驱动等。
...
* 算法工程师在一些领域发挥核心作用，如：大数据、人工智能、机器学习、云计算等。
...
| 嵌入式领域             | 应用场景                         | 技术/平台                       |
| ---------------------- | -------------------------------- | ------------------------------- |
| 消费电子               | 智能手机、智能家居、可穿戴设备   | ARM 架构、Android、RTOS         |
| 汽车电子               | 自动驾驶、车载娱乐系统、ADAS     | AUTOSAR、QNX、RTOS              |
| 工业自动化、机械自动化 | 机器人、PLC 控制、智能工厂       | 嵌入式 Linux、RTOS、Modbus      |
| 医疗设备               | 便携式医疗仪器、心率监测器       | ARM Cortex、FreeRTOS、Bluetooth |
| 网络设备               | 路由器、交换机、无线接入点       | Linux、RTOS、802.11、LTE        |
| 航空航天               | 飞行控制系统、卫星通信、导航系统 | RTOS、FPGA、VxWorks             |
| 消费级游戏设备         | 游戏主机、便携游戏设备           | ARM、Unity、RTOS                |
| 家电控制               | 空调、冰箱、洗衣机               | RTOS、ARM、通信协议             |
| 农业技术               | 智能灌溉、环境监测系统           | Arduino、Raspberry Pi、LoRa     |
