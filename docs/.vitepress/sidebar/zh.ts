    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          {text: 'Java 网络编程', link: `/01_java-se/java-senior/07_${commonDirectoryName}/`},
          {text: 'Java 类的加载和反射', link: `/01_java-se/java-senior/08_${commonDirectoryName}/`},
          {text: 'Java 枚举和注解', link: `/01_java-se/java-senior/09_${commonDirectoryName}/`},
          {text: 'Java 单元测试和日志技术', link: `/01_java-se/java-senior/10_${commonDirectoryName}/`},
        ]
      },
    ]
  },
