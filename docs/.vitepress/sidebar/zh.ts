    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Java 常见 API', link: `/01_java-se/java-leap/09_${commonDirectoryName}/` },
          { text: 'Java 异常', link: `/01_java-se/java-leap/10_${commonDirectoryName}/` },
          { text: 'Java 多线程', link: `/01_java-se/java-leap/11_${commonDirectoryName}/` },
          { text: 'Java 集合', link: `/01_java-se/java-leap/12_${commonDirectoryName}/` },
        ]
      },
      {
        text: 'Java 语言高级',
