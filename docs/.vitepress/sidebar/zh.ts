    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          {text: 'Java IO（一）', link: `/01_java-se/java-senior/07_${commonDirectoryName}/`},
          {text: 'Java IO（二）', link: `/01_java-se/java-senior/08_${commonDirectoryName}/`},
          {text: 'Java 多线程（一）', link: `/01_java-se/java-senior/09_${commonDirectoryName}/`},
          {text: 'Java 多线程（二）', link: `/01_java-se/java-senior/10_${commonDirectoryName}/`},
